...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' %help','LEGENDS_YT','Have Fun !',' Iam Here For Games',' %help'];
    var i = -1;
    var j = 0;
...
client.login('NTUyNTczODMwMTI4NzMwMTE0.D2eXWg._RdAJJeU2vCFprvXf1iO9NyNlBQ');